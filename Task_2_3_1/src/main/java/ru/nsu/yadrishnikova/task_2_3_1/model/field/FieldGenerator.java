package ru.nsu.yadrishnikova.task_2_3_1.model.field;

import ru.nsu.yadrishnikova.task_2_3_1.model.Food;
import ru.nsu.yadrishnikova.task_2_3_1.model.Obstacle;
import ru.nsu.yadrishnikova.task_2_3_1.model.Position;
import ru.nsu.yadrishnikova.task_2_3_1.model.Tile;
    ...
    public static Field generateFieldFromFile(String fileName) {
        try (
                InputStream is = FieldGenerator.class.getClassLoader().getResourceAsStream(
                        "ru/nsu/fit/oop/snake/model/levels/" + fileName
                );
